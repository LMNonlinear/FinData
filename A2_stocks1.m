...
predictor2(returns_full,400,'tLocationScale',t)
...
q = 0:0.05:4;
[mean_hursts,std_hursts]=genhurst(prices,q,100); 
...
plot(R_x,R_epdf)
plot(R_x,R_ppdf)
legend({'empirical pdf','fitted Student-t pdf'},'location','NorthWest','fontsize',12)
